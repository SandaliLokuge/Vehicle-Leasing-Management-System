 ...
 * @author Sandali
 */
public class GuarantorIDController {

    public static String getLastGuarantorId(String tablename, String colomnname) throws ClassNotFoundException, SQLException {
